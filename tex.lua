...
local formatInfos = table{
	...
	{internalFormat='GL_RGB565', format='GL_RGB', types={'GL_UNSIGNED_BYTE', 'GL_UNSIGNED_SHORT_5_6_5'}, redBits=5, greenBits=6, blueBits=5, colorRenderable=true, textureRenderable=true},
	-- GL4 and GLES3 merged:
	{internalFormat='GL_R8', baseInternalFormat='GL_RED', format='GL_RED', types={'GL_UNSIGNED_BYTE'}, redBits=8, colorRenderable='true', textureRenderable='true'},
	{internalFormat='GL_R8_SNORM', baseInternalFormat='GL_RED', format='GL_RED', types={'GL_BYTE'}, redBits=8, colorRenderable='false', textureRenderable='true', internalType='s'},
	{internalFormat='GL_R16F', baseInternalFormat='GL_RED', format='GL_RED', types={'GL_HALF_FLOAT', 'GL_FLOAT'}, redBits=16, colorRenderable='false', textureRenderable='true', internalType='f'},
	{internalFormat='GL_R32F', baseInternalFormat='GL_RED', format='GL_RED', types={'GL_FLOAT'}, redBits=32, colorRenderable='false', textureRenderable='false', internalType='f'},
	{internalFormat='GL_R8UI', baseInternalFormat='GL_RED', format='GL_RED_INTEGER', types={'GL_UNSIGNED_BYTE'}, redBits=8, colorRenderable='true', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_R8I', baseInternalFormat='GL_RED', format='GL_RED_INTEGER', types={'GL_BYTE'}, redBits=8, colorRenderable='true', textureRenderable='false', internalType='i'},
	{internalFormat='GL_R16UI', baseInternalFormat='GL_RED', format='GL_RED_INTEGER', types={'GL_UNSIGNED_SHORT'}, redBits=16, colorRenderable='true', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_R16I', baseInternalFormat='GL_RED', format='GL_RED_INTEGER', types={'GL_SHORT'}, redBits=16, colorRenderable='true', textureRenderable='false', internalType='i'},
	{internalFormat='GL_R32UI', baseInternalFormat='GL_RED', format='GL_RED_INTEGER', types={'GL_UNSIGNED_INT'}, redBits=32, colorRenderable='true', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_R32I', baseInternalFormat='GL_RED', format='GL_RED_INTEGER', types={'GL_INT'}, redBits=32, colorRenderable='true', textureRenderable='false', internalType='i'},
	{internalFormat='GL_RG8', baseInternalFormat='GL_RG', format='GL_RG', types={'GL_UNSIGNED_BYTE'}, redBits=8, greenBits=8, colorRenderable='true', textureRenderable='true'},
	{internalFormat='GL_RG8_SNORM', baseInternalFormat='GL_RG', format='GL_RG', types={'GL_BYTE'}, redBits=8, greenBits=8, colorRenderable='false', textureRenderable='true', internalType='s'},
	{internalFormat='GL_RG16F', baseInternalFormat='GL_RG', format='GL_RG', types={'GL_HALF_FLOAT', 'GL_FLOAT'}, redBits=16, greenBits=16, colorRenderable='false', textureRenderable='true', internalType='f'},
	{internalFormat='GL_RG32F', baseInternalFormat='GL_RG', format='GL_RG', types={'GL_FLOAT'}, redBits=32, greenBits=32, colorRenderable='false', textureRenderable='false', internalType='f'},
	{internalFormat='GL_RG8UI', baseInternalFormat='GL_RG', format='GL_RG_INTEGER', types={'GL_UNSIGNED_BYTE'}, redBits=8, greenBits=8, colorRenderable='true', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_RG8I', baseInternalFormat='GL_RG', format='GL_RG_INTEGER', types={'GL_BYTE'}, redBits=8, greenBits=8, colorRenderable='true', textureRenderable='false', internalType='i'},
	{internalFormat='GL_RG16UI', baseInternalFormat='GL_RG', format='GL_RG_INTEGER', types={'GL_UNSIGNED_SHORT'}, redBits=16, greenBits=16, colorRenderable='true', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_RG16I', baseInternalFormat='GL_RG', format='GL_RG_INTEGER', types={'GL_SHORT'}, redBits=16, greenBits=16, colorRenderable='true', textureRenderable='false', internalType='i'},
	{internalFormat='GL_RG32UI', baseInternalFormat='GL_RG', format='GL_RG_INTEGER', types={'GL_UNSIGNED_INT'}, redBits=32, greenBits=32, colorRenderable='true', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_RG32I', baseInternalFormat='GL_RG', format='GL_RG_INTEGER', types={'GL_INT'}, redBits=32, greenBits=32, colorRenderable='true', textureRenderable='false', internalType='i'},
	{internalFormat='GL_RGB8', baseInternalFormat='GL_RGB', format='GL_RGB', types={'GL_UNSIGNED_BYTE'}, redBits=8, greenBits=8, blueBits=8, colorRenderable='true', textureRenderable='true'},
	{internalFormat='GL_SRGB8', baseInternalFormat='GL_RGB', format='GL_RGB', types={'GL_UNSIGNED_BYTE'}, redBits=8, greenBits=8, blueBits=8, colorRenderable='false', textureRenderable='true'},
	{internalFormat='GL_RGB8_SNORM', baseInternalFormat='GL_RGB', format='GL_RGB', types={'GL_BYTE'}, redBits=8, greenBits=8, blueBits=8, colorRenderable='false', textureRenderable='true', internalType='s'},
	{internalFormat='GL_R11F_G11F_B10F', baseInternalFormat='GL_RGB', format='GL_RGB', types={'GL_UNSIGNED_INT_10F_11F_11F_REV', 'GL_HALF_FLOAT', 'GL_FLOAT'}, redBits=11, greenBits=11, blueBits=10, colorRenderable='false', textureRenderable='true', internalType='f'},
	{internalFormat='GL_RGB9_E5', baseInternalFormat='GL_RGB', format='GL_RGB', types={'GL_UNSIGNED_INT_5_9_9_9_REV', 'GL_HALF_FLOAT', 'GL_FLOAT'}, redBits=9, greenBits=9, blueBits=9, sharedBits=5, colorRenderable='false', textureRenderable='true'},
	{internalFormat='GL_RGB16F', baseInternalFormat='GL_RGB', format='GL_RGB', types={'GL_HALF_FLOAT', 'GL_FLOAT'}, redBits=16, greenBits=16, blueBits=16, colorRenderable='false', textureRenderable='true', internalType='f'},
	{internalFormat='GL_RGB32F', baseInternalFormat='GL_RGB', format='GL_RGB', types={'GL_FLOAT'}, redBits=32, greenBits=32, blueBits=32, colorRenderable='false', textureRenderable='false', internalType='f'},
	{internalFormat='GL_RGB8UI', baseInternalFormat='GL_RGB', format='GL_RGB_INTEGER', types={'GL_UNSIGNED_BYTE'}, redBits=8, greenBits=8, blueBits=8, colorRenderable='false', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_RGB8I', baseInternalFormat='GL_RGB', format='GL_RGB_INTEGER', types={'GL_BYTE'}, redBits=8, greenBits=8, blueBits=8, colorRenderable='false', textureRenderable='false', internalType='i'},
	{internalFormat='GL_RGB16UI', baseInternalFormat='GL_RGB', format='GL_RGB_INTEGER', types={'GL_UNSIGNED_SHORT'}, redBits=16, greenBits=16, blueBits=16, colorRenderable='false', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_RGB16I', baseInternalFormat='GL_RGB', format='GL_RGB_INTEGER', types={'GL_SHORT'}, redBits=16, greenBits=16, blueBits=16, colorRenderable='false', textureRenderable='false', internalType='i'},
	{internalFormat='GL_RGB32UI', baseInternalFormat='GL_RGB', format='GL_RGB_INTEGER', types={'GL_UNSIGNED_INT'}, redBits=32, greenBits=32, blueBits=32, colorRenderable='false', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_RGB32I', baseInternalFormat='GL_RGB', format='GL_RGB_INTEGER', types={'GL_INT'}, redBits=32, greenBits=32, blueBits=32, colorRenderable='false', textureRenderable='false', internalType='i'},
	{internalFormat='GL_RGBA8', baseInternalFormat='GL_RGBA', format='GL_RGBA', types={'GL_UNSIGNED_BYTE'}, redBits=8, greenBits=8, blueBits=8, alphaBits=8, colorRenderable='true', textureRenderable='true'},
	{internalFormat='GL_SRGB8_ALPHA8', baseInternalFormat='GL_RGBA', format='GL_RGBA', types={'GL_UNSIGNED_BYTE'}, redBits=8, greenBits=8, blueBits=8, alphaBits=8, colorRenderable='true', textureRenderable='true'},
	{internalFormat='GL_RGBA8_SNORM', baseInternalFormat='GL_RGBA', format='GL_RGBA', types={'GL_BYTE'}, redBits=8, greenBits=8, blueBits=8, alphaBits=8, colorRenderable='false', textureRenderable='true', internalType='s'},
	{internalFormat='GL_RGB5_A1', baseInternalFormat='GL_RGBA', format='GL_RGBA', types={'GL_UNSIGNED_BYTE', 'GL_UNSIGNED_SHORT_5_5_5_1', 'GL_UNSIGNED_INT_2_10_10_10_REV'}, redBits=5, greenBits=5, blueBits=5, alphaBits=1, colorRenderable='true', textureRenderable='true'},
	{internalFormat='GL_RGBA4', baseInternalFormat='GL_RGB', format='GL_RGBA', types={'GL_UNSIGNED_BYTE', 'GL_UNSIGNED_SHORT_4_4_4_4'}, redBits=4, greenBits=4, blueBits=4, alphaBits=4, colorRenderable='true', textureRenderable='true'},
	{internalFormat='GL_RGB10_A2', baseInternalFormat='GL_RGBA', format='GL_RGBA', types={'GL_UNSIGNED_INT_2_10_10_10_REV'}, redBits=10, greenBits=10, blueBits=10, alphaBits=2, colorRenderable='true', textureRenderable='true'},
	{internalFormat='GL_RGBA16F', baseInternalFormat='GL_RGBA', format='GL_RGBA', types={'GL_HALF_FLOAT', 'GL_FLOAT'}, redBits=16, greenBits=16, blueBits=16, alphaBits=16, colorRenderable='false', textureRenderable='true', internalType='f'},
	{internalFormat='GL_RGBA32F', baseInternalFormat='GL_RGBA', format='GL_RGBA', types={'GL_FLOAT'}, redBits=32, greenBits=32, blueBits=32, alphaBits=32, colorRenderable='false', textureRenderable='false', internalType='f'},
	{internalFormat='GL_RGBA8UI', baseInternalFormat='GL_RGBA', format='GL_RGBA_INTEGER', types={'GL_UNSIGNED_BYTE'}, redBits=8, greenBits=8, blueBits=8, alphaBits=8, colorRenderable='true', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_RGBA8I', baseInternalFormat='GL_RGBA', format='GL_RGBA_INTEGER', types={'GL_BYTE'}, redBits=8, greenBits=8, blueBits=8, alphaBits=8, colorRenderable='true', textureRenderable='false', internalType='i'},
	{internalFormat='GL_RGB10_A2UI', baseInternalFormat='GL_RGBA', format='GL_RGBA_INTEGER', types={'GL_UNSIGNED_INT_2_10_10_10_REV'}, redBits=10, greenBits=10, blueBits=10, alphaBits=2, colorRenderable='true', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_RGBA16UI', baseInternalFormat='GL_RGBA', format='GL_RGBA_INTEGER', types={'GL_UNSIGNED_SHORT'}, redBits=16, greenBits=16, blueBits=16, alphaBits=16, colorRenderable='true', textureRenderable='false', internalType='ui'},
	{internalFormat='GL_RGBA16I', baseInternalFormat='GL_RGBA', format='GL_RGBA_INTEGER', types={'GL_SHORT'}, redBits=16, greenBits=16, blueBits=16, alphaBits=16, colorRenderable='true', textureRenderable='false', internalType='i'},
	{internalFormat='GL_RGBA32I', baseInternalFormat='GL_RGBA', format='GL_RGBA_INTEGER', types={'GL_INT'}, redBits=32, greenBits=32, blueBits=32, alphaBits=32, colorRenderable='true', textureRenderable='false', internalType='i'},
	{internalFormat='GL_RGBA32UI', baseInternalFormat='GL_RGBA', format='GL_RGBA_INTEGER', types={'GL_UNSIGNED_INT'}, redBits=32, greenBits=32, blueBits=32, alphaBits=32, colorRenderable='true', textureRenderable='false', internalType='ui'},
